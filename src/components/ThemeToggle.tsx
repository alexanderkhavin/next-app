...
<button
  onClick={toggleTheme}
  className="p-2 rounded-lg bg-blue-800 dark:bg-gray-800 hover:bg-blue-700 dark:hover:bg-gray-700 transition-all duration-200 ease-in-out text-center cursor-pointer"
